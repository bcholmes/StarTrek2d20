...
class WorkflowStep {
    ...
    constructor(name: string, description: string[] = [], talentPrompt: boolean = false, page: PageIdentity = undefined, options: WorkflowStepOptions = new WorkflowStepOptions(true, false)) {
        this.name = name;
...
class Workflows {
    starfleetWorkflow: Workflow = new Workflow([
        ...
        new WorkflowStep("Career", ["At this stage, you have a choice to make about the character. This decision is a clear one: are you a young officer, fresh out of the Academy, with your whole career ahead of you, have you served in Starfleet for several years, or are you a veteran with decades of experience?", "Either select or roll your Career."], true, PageIdentity.Career),
        new WorkflowStep("Career Events", ["Your career is a tapestry of events and experiences, but amongst this, a few will have been pivotal moments in your life. Define which moments of your life are important in retrospect, and what seemed definitive to an ensign in their early 20s may be inconsequential to that same officer decades later.", "Either select or roll a Career Event."], false, PageIdentity.CareerEvent1),
    ...
    ambasssadorWorkflow: Workflow = new Workflow([
        ...
        new WorkflowStep("Upbringing", ["The nature of a person’s family and their surroundings as they grew up can have a massive impact upon them, and, whether they accept this influence or rebelled against it, it will shape the rest of their lives.", "Either select or roll your Upbringing."]),
        new WorkflowStep("Training", ["The years spent in training are some of the most memorable and definitive of an diplomat’s life, shaping the direction of their career going forwards. Diplomatic training takes years, covering a mixture of intense training, academic studies, and practical experiences."], false, PageIdentity.StarfleetAcademy),
        new WorkflowStep("Career", ["At this stage, you have a choice to make about the character. This decision is a clear one: are you a young officer, fresh out of the Academy, with your whole career ahead of you, have you served in Starfleet for several years, or are you a veteran with decades of experience?", "Either select or roll your Career."], true, PageIdentity.Career),
        new WorkflowStep("Career Events", ["Your career is a tapestry of events and experiences, but amongst this, a few will have been pivotal moments in your life. Define which moments of your life are important in retrospect, and what seemed definitive to an ensign in their early 20s may be inconsequential to that same officer decades later.", "Either select or roll a Career Event."], false, PageIdentity.CareerEvent1),
        new WorkflowStep("Finishing Touches", [], false)
    ]);
    ...
    childWorkflow: Workflow = new Workflow([
        ...
        new WorkflowStep("Upbringing", ["The nature of a person’s family and their surroundings as they grew up can have a massive impact upon them, and, whether they accept this influence or rebelled against it, it will shape the rest of their lives.", "Either select or roll your Upbringing."]),
        new WorkflowStep("Education", ["Naturally, a child has not attended Starfleet Academy (or any of its counterparts), or any institute of higher education. Indeed, they’re still in their earlier stages of education.", "Select an age for your character."], false, PageIdentity.ChildEducationPage),
        new WorkflowStep("Career", ["Naturally, a child character doesn’t have much in the way of a career."], true, PageIdentity.ChildCareer),
    ...
    alliedMilitaryWorkflow: Workflow = new Workflow([
        ...
        new WorkflowStep("Upbringing", ["The nature of a person’s family and their surroundings as they grew up can have a massive impact upon them, and, whether they accept this influence or rebelled against it, it will shape the rest of their lives.", "Either select or roll your Upbringing."]),
        new WorkflowStep("Training", ["You have chosen to commit your life to your government's military. You have undergone necessary training to prepare for your military role, whether that be formal officer education, or much more informal guerilla training."], false, PageIdentity.StarfleetAcademy),
        new WorkflowStep("Career", ["At this stage, you have a choice to make about the character: is the character a young officer, fresh out of training, have they served in the military for several years, or are they a veteran with decades of experience?", "Either select or roll your Career."], true, PageIdentity.Career),
        new WorkflowStep("Career Events", ["The character’s career is a tapestry of events and experiences, but amongst this, a few will have been pivotal moments in the character’s life. A character defines which moments of their life are important in retrospect, and what seemed definitive to a young officer may be inconsequential to that same officer decades years later.", "Either select or roll a Career Event."], false, PageIdentity.CareerEvent1),
        new WorkflowStep("Finishing Touches", [], false)
    ]);
