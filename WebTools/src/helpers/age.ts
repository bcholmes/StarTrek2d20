...
export class Age {
    ...
    constructor(name: string, attributes: number[], disciplines: number[], attributeSum: number, disciplineSum: number, decreasePoints: number = 0, description: string = "") {
        this.name = name;
...
class _AgeHelper {
    ...
    private ages: Age[] = [
        ...
        new Age("Pre-adolescent Child", [9, 8, 8, 7, 7, 6], [3, 2, 1, 1, 0, 0], 54, 14, 2,
            "You’re young, equivalent to a Human child between the ages of 8 and 12. You’re still learning your way in the world."),
        new Age("Adolescent Child", [9, 9, 8, 8, 7, 7], [3, 2, 2, 1, 1, 0], 55, 15, 1,
