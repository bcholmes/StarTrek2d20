...
export class AgeLifepathOptions {
    ...
    decreaseAttributes: number;
    // the number of points that a character of this age should decrease
    decreaseDisciplines: number;
    // the number of focuses that the character gains during the training/academy/education phase
    numberOfFocuses: number;
    focusText: string;

    constructor(decreaseAttributes: number = 0, decreaseDisciplines: number = 0, numberOfFocuses: number = 3, focusText="") {
        this.decreaseAttributes = decreaseAttributes;
        this.decreaseDisciplines = decreaseDisciplines;
...
class _AgeHelper {
    ...
    private ages: Age[] = [
        ...
        new Age("Pre-adolescent Child", [9, 8, 8, 7, 7, 6], [3, 2, 1, 1, 0, 0], 52, 12,
            new AgeLifepathOptions(2, 2, 1, "You select one focus. This should reflect your areas of interest, one of your hobbies or the school subject you excel at."),
        ...
        new Age("Adolescent Child", [9, 9, 8, 8, 7, 7], [3, 2, 2, 1, 1, 0], 53, 13,
            new AgeLifepathOptions(1, 1, 2, "You select two focuses. These should reflect your areas of interest, your hobbies or the school subjects you excel at."),
