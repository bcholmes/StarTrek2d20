...
class EnvironmentModel {
    ...
    constructor(id: Environment, name: string, description: string, attributes: Attribute[], disciplines: Skill[]) {
        this.id = id;
        this.name = name;
...
class EnvironmentViewModel extends EnvironmentModel {
    constructor(id: Environment, base: EnvironmentModel) {
        super(base.id, base.name, base.description, base.attributes, base.disciplines);
        this.id = id;
