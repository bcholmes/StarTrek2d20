...
const SCIENCE_DISCIPLINES = new Specialty({
  ...
  History: [
    ...
    'Economic History',
    'Diplomatic History',
    'History of Oppression and Liberation',
    'Cultural History',
    'Archival Science',
    ...
    this.specializations = [
      new SpecializationModel(
        ...
        [
          ...
          'Starfleet Ships and their Captains',
          'Outside-of-the-box Tactics',
          'Current Border Readiness',
          'External Polity Intelligence',
          'Negotiation',
          ...
          'Tzenkethi Treaties',
          'Klingon Military Deployments',
          'Romulan Battle Strategies',
          'Romulan Coups',
          'Cardassian Governmental Policy',
          'The Strategies of Adm. Nogura',
          'Interstellar Law',
        ],
        [
      ...
      new SpecializationModel(
        Specialization.StationCommander,
        NpcCharacterType.Starfleet,
        'Station Commander',
        [Attribute.Control, Attribute.Presence, Attribute.Reason],
        Department.Command,
        ...
        [
          ...
          'Sector Starship Assignments',
          'Interstellar Politics',
          'Recreation',
          'Starship Supply Management',
          'Billeting',
          'Starship Repair Scheduling',
          'Negotiation',
          'Resouce Allocation',
        ],
        [
      ...
      new SpecializationModel(
        ...
        [
          'High Warp Maneuvers',
          'Warp Trail Identification',
          'High Gravity Maneuvers',
          'Starship Landing Procedures',
          'Stellar Systems',
      ...
      new SpecializationModel(
        ...
        [
          ...
          'Work Bee Specialist',
          'Stevedore',
          'Shuttle Docking Procedures',
          'Call Signals',
          'Shuttle Approach Protocols',
          'Small Craft Engines',
        ],
        [
          'Shuttle Stacking',
          'Small Craft Identification',
          'Shuttle Parts and Supply',
          'Cargo Identification and Storage',
      ...
      new SpecializationModel(
        ...
        [
          'Dilithium Inspection',
          'Specialized Engineering Equipment',
          'Emergency Protocols',
          'Holodeck Repair',
          'Communciations Systems',
          'Equipment Diagnostics',
          'Away Team Equipment Repair',
          'EVA Operations',
          'Leading-Edge Engineering Advances',
          'Subspace Theory',
          'Alternative Propulsion Theory',
          'Fusion Reactors',
          'Sensor Calibration',
          'Jury-Rigging',
          'Imaging Equipment',
      ...
      new SpecializationModel(
        ...
        [
          ...
          'The Prime Directive',
          'Standard Technology Progression Models',
      ...
      new SpecializationModel(
        ...
        [
          ...
          'Legal Jurisdictions',
          'Sneaky Legal Maneuvers',
          'The Writings of Sam Cogley',
          'Evaluating Testimony',
          'Argument Weakness Detection',
          'Forensics',
          'Investigative Methods',
          'The Prime Directive in Depth',
          'Klingon Law',
          'Cardassian Law',
          'Romulan Law',
          'Sheliak Law',
          'Expert Testimony Preparation',
          'Rulings of the Tribunal of Alpha III',
        ],
        [
      ...
      new SpecializationModel(
        ...
        [
          ...
          'Medical Tricorders and Sensors',
          'Infectious Diseases',
          'Xenobiology',
          'Esoteric Medicine',
          'Neurology',
      ...
      new SpecializationModel(
        ...
        [
          ...
          'Starfleet Science Protocols',
          'Daystrom Institute Research Priorities',
          'The Works of Gideon Seyetik',
          'The Works of Sitar',
      ...
      new SpecializationModel(
        ...
        [
          ...
          new Value(
            ...
            'bitter about current political climate',
          ),
      ...
      new SpecializationModel(
        ...
        [
          ...
          'Relations with the Romulan Star Empire',
          'The History of the Empire',
          'Tholian Diplomatic Complexities',
          'Schmoozing',
          'Political Leaders and their Agendas',
      ...
      new SpecializationModel(
        ...
        [
          'Trade',
          'Commerce Protocols',
          'FCA Punitive Actions',
          'Intimidation',
          'Interrogation',
          'Bureaucracy',
          'Record Falsification Tricks',
          'Union Busting',
        ],
        [
      ...
      new SpecializationModel(
        ...
        [
          'Alcohol interaction with different species',
          'Rare Vintages',
          'Alcohol Importing',
          'Holosuites',
          'Accounting',
      ...
      new SpecializationModel(
        ...
        [
          ...
          'Philosophy',
          'Alliance-building',
          'Romulan Governmental Priorities',
          'Senatorial Protocol',
        ],
        [
          'Romulan Senators and their Histories',
          'State Secrets',
          'Budgeting',
          'Obfuscation',
          'Bluffing',
          'Romulan History and Traditions',
        ],
        [
      ...
      new SpecializationModel(
        ...
        [
          ...
          'Guerilla Tactics',
          'Training Games',
          'Talarian Age-of-Decision Tests',
          'Ship Sensors',
        ],
        [
      ...
      new SpecializationModel(
        ...
        Department.Security,
        [
          'Starship Breach Tactics',
          'Tractor Beams',
          'Starship Disarming Techniques',
          'Valuation',
          'Ambushes and Traps',
          'Starship Detection Prevention',
        ],
        [
          'Generating Fear',
          'Slavery',
      ...
      new SpecializationModel(
        ...
        [
          ...
          'Tracer Evasion Techniques',
          'Shady Dealings',
          'Stealth',
          'Data Tapping Technology',
          'Dive Bars',
        ],
        [
          'I hacked the Gibson',
      ...
      new SpecializationModel(
        ...
        0,
        [Species.Nausicaan, Species.Klingon],
      ),
      new SpecializationModel(
        ...
        0,
        [Species.Nausicaan, Species.Hupyrian],
      ),
      new SpecializationModel(
        ...
        [
          ...
          'Distracting Authorities',
          'Uncommon Trade Routes',
          'Detection Evasion',
          'Scan Suppressing Technology',
        ],
        [
      ...
      new SpecializationModel(
        ...
        [
          ...
          'History of Guerilla Actions',
          'Acceptable Sacrifice',
          'Hostage Situations',
          'Cell-based Organizational Structures',
          'Information Control',
          'Leadership',
      ...
      new SpecializationModel(
        ...
        [
          'Relations with the Klingon Empire',
          'Relations with the Romulan Star Empire',
          'The History of the Federation',
          'The Writings of Ambassador Archer',
          'The History of Ambassador Sarek',
          'The Accomplishments of Ambassador Gav',
          'Diplomatic Strategies of Ambassador Riva',
          'Shmoozing',
          'Diplomatic Protocol',
          'Abiguous Treaty Clauses',
          'Tholian Diplomatic Complexities',
          "V'Lar's Negotiating Tactics",
          'Out-of-the-ordinary Compromises',
          'Finer Details of Agreements',
          'Political Leaders and their Agendas',
          'Psychology',
          'Current Political Issues',
        ],
      ...
      new SpecializationModel(
        ...
        ['Civics', 'Bribery', 'Organizational Hierarchy', 'Legalese'],
        [
          'Details matter.',
          'Not without the proper paperwork!',
          'Without processes, society would devolve into chaos!',
          ...
          'Bureaucrats are the only people in the world who can say absolutely nothing and mean it.',
          new Value(
            "I wish I could help you, but I'm afraid it's entirely out of my hands",
            'obstructionist',
          ),
          new Value(
            "I'm sorry, but you're missing some essential approvals. Request denied.",
            'intransigent',
          ),
        ],
        0,
      ...
      new SpecializationModel(
        Specialization.ObsidianOrderOperative,
        NpcCharacterType.Cardassian,
        ...
        [
          new Value(
            'Everyone is guilty of something, but who is guilty of what?',
            'untrusting',
          ),
          new Value(
          ...
          new Value('Never underestimate my gift for survival', 'determined'),
          new Value(
      ...
      new SpecializationModel(
        ...
        NpcCharacterType.Civilian,
        'Journalist',
        [Attribute.Presence, Attribute.Insight, Attribute.Daring],
        Department.Command,
        [
          'Debate',
          'Journalism',
        ...
        [
          ...
          'The duty of the journalist is to comfort the afflicted and to afflict the comfortable',
        ],
        0,
      ),
      new SpecializationModel(
      ...
      new SpecializationModel(
        Specialization.BreenEliteGuard,
        NpcCharacterType.MinorPolity,
        'Breen Elite Guard',
        [Attribute.Fitness, Attribute.Presence, Attribute.Control],
        Department.Security,
      ...
      new SpecializationModel(
        Specialization.BorgTacticalDrone,
        ...
        [
          ...
          'We have adapted to your defenses',
      ...
      new SpecializationModel(
        Specialization.BorgTechnicalDrone,
        NpcCharacterType.Borg,
        'Borg Technical Drone',
        [Attribute.Control, Attribute.Fitness, Attribute.Reason],
        Department.Engineering,
        [
          'Warp Drive Maintenance',
        ...
        [
          ...
          'A component that cannot be repaired must be recycled',
          'Essential components cannot allow any variance from the specification',
          'Your technology will be added to our own',
          'Your resources will be repurposed',
          'Your technology is obsolete',
          'Our technology is superior to yours',
        ],
        1,
        [Species.Borg],
      ),
      new SpecializationModel(
        Specialization.BorgMedicalDrone,
        NpcCharacterType.Borg,
        'Borg Medical Drone',
        [Attribute.Control, Attribute.Fitness, Attribute.Reason],
        Department.Medicine,
        ...
        [
          'Every organism we encounter must be assimilated',
          'Assimilation is the next stage of evolution',
          'We will improve your species',
      ...
      new SpecializationModel(
        Specialization.BorgAdjunctDrone,
        NpcCharacterType.Borg,
        'Borg Adjunct Drone',
        [Attribute.Control, Attribute.Fitness, Attribute.Reason],
        Department.Command,
        ['Planning', 'Status Assessment', 'Prioritization', 'Communication'],
        [
          'Risk Assessment',
          'Mission Parameters',
          'Negotiation',
        ...
        [
          ...
          'All will be made one',
          'We do not see you as a threat. We see you as a resource',
          'You will serve the Collective',
          'We are the harbingers of a new world',
          'Unity through conformity is our mission',
          'Embrace the collective, for it increases your strength',
          'A single mind is a burden; a collective mind is freedom',
        ],
        1,
        [Species.Borg],
      ),
