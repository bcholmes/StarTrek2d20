        ...
        return (<div className="mb-2">
            ...
            <div className="d-lg-flex justify-content-between">
                <div className="mb-2" style={{width: "380px"}}>
                    ...
                    <div className="row row-cols-1 row-cols-md-3 mt-1">
                        <StatView name={t(makeKey('Construct.discipline.', Skill[Skill.Command]))} value={character.departments ? character.departments[Skill.Command] : undefined} className="col mb-1" size="sm" />
                        <StatView name={t(makeKey('Construct.discipline.', Skill[Skill.Security]))} value={character.departments ? character.departments[Skill.Security] : undefined} className="col mb-1" size="sm" />
                        <StatView name={t(makeKey('Construct.discipline.', Skill[Skill.Science]))} value={character.departments ? character.departments[Skill.Science] : undefined} className="col mb-1" size="sm" />
                        <StatView name={t(makeKey('Construct.discipline.', Skill[Skill.Conn]))} value={character.departments ? character.departments[Skill.Conn] : undefined} className="col mb-1" size="sm" />
                        <StatView name={t(makeKey('Construct.discipline.', Skill[Skill.Engineering]))} value={character.departments ? character.departments[Skill.Engineering] : undefined} className="col mb-1" size="sm" />
                        <StatView name={t(makeKey('Construct.discipline.', Skill[Skill.Medicine]))} value={character.departments ? character.departments[Skill.Medicine] : undefined} className="col mb-1" size="sm" />
                    </div>
                </div>
