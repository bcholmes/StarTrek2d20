...
import { Sector, Star } from "../table/star";
    ...
    render() {
        ...
        return this.props.sector ?(<div className="sectorMap mx-auto">
            <svg
                ...
                >
		    	<path strokeWidth="1" stroke-opacity="50%" fill="none" stroke={purple} d="M105,25 L105,425 M185,25 L185,425 M265,25 L265,425 M345,25 L345,425" />
		    	<path strokeWidth="1" stroke-opacity="50%" fill="none" stroke={purple} d="M25,105 L425,105 M25,185 L425,185 M25,265 L425,265 M25,345 L425,345 " />
