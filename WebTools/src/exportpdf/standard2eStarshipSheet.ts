...
export class Standard2eStarshipSheet extends BasicGeneratedSheet {
  ...
  static readonly talentsColumn1 = new Column(
    107.6,
    526.3,
    222.4,
    227.8,
  ...
  async populate(pdf: PDFDocument, construct: Construct) {
    ...
    SpaceframeOutline.draw(
      ...
      new SheetOutlineOptions(
        new XYLocation(98.6, 70.4),
        blueColour2e.asPdfRbg(),
        0.66,
        0.8,
      ),
      starship,
    ...
    await this.writeTalents(
      page,
      starship,
      Standard2eStarshipSheet.talentsColumn1,
      blueColour2e,
    );
    await this.writeSpecialRules(
      page,
      starship,
      Standard2eStarshipSheet.specialRulesColumn,
      blueColour2e,
    );
  ...
  populateForm(page: PDFPage, form: PDFForm, starship: Starship) {
    ...
    this.fillField(
      form,
      'Service Record',
      starship.serviceRecordStep?.type?.name ?? '',
    );
  ...
  writeLabels(page: PDFPage, construct: Starship) {
    ...
    labelWriter(
      page,
      {
        ...
        'Construct.other.missionProfile': new Column(
          56.8 + 3,
          186.9 + 2,
          6,
          224.7 - 5,
        ),
        'Construct.other.serviceRecord': new Column(
          287.4 + 3,
          186.9 + 1,
          6,
          140.4 - 5,
        ...
        'Construct.other.shuttlebay': new Column(
          342.1 + 3,
          336.6 + 1,
          6,
          234.1 - 5,
        ),
        'Construct.other.specialRules': new Column(
          342.1 + 3,
          375.4 + 1,
          6,
          234.1 - 5,
        ),
        'Construct.other.talents': new Column(
          103.8 + 3,
          511.9 + 1,
          6,
          472.6 - 5,
        ...
        'Construct.other.serviceDate': new Column(
          434 + 3,
          102.4 + 1,
          6,
          143 - 5,
        ...
        'Construct.other.resistance': new Column(
          439.6 + 3,
          161.1 + 1,
          6,
          131.4 - 5,
        ...
        'Construct.other.crewSupport': new Column(
          439.6 + 3,
          213.1 + 1,
          6,
          131.4 - 5,
    ...
    const paragraph = new Paragraph(
      page,
      new Column(518.2, 249.9, 19.6, 54.6),
      this.fonts,
    );
    paragraph.textAlignment = TextAlign.Centre;
    paragraph.append(
      i18next.t('Construct.other.smallCraftReadiness').toLocaleUpperCase(),
  ...
  writeTitle(page: PDFPage) {
    const originalText = i18next
      .t('Sheet.text.title.starship')
      .toLocaleUpperCase();
    let text = originalText;
    const fontSize = determineIdealFontWidth(
      [text],
      Standard2eStarshipSheet.headingColumn.width,
      11,
      8,
      this.headingFont,
    );
