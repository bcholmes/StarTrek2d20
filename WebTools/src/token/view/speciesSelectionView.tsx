...
class SpeciesSelectionView extends React.Component<ISpeciesSelectionProperties, {}> {
    ...
    speciesList() {
        return [Species.Bajoran, Species.Deltan, Species.Human, Species.Orion, Species.Trill, Species.Vulcan].map(s => new DropDownElement(s, SpeciesHelper.getSpeciesByType(s).name));
    }
}
